describe('Add Liquidity', () => {
  it('loads the two correct tokens', () => {
    ...
    cy.get('#add-liquidity-input-tokenb .token-symbol-container').should('contain.text', 'ETD')
  })
  ...
  it('does not crash if ETD is duplicated', () => {
    ...
    cy.get('#add-liquidity-input-tokena .token-symbol-container').should('contain.text', 'ETD')
    cy.get('#add-liquidity-input-tokenb .token-symbol-container').should('not.contain.text', 'ETD')
  })
